...
- **said** — a line of the sheet names one polymer, and the line is quoted: 28
...
| AmphoraHT5300 | colorFabb | Not read | Not read | this maker's range: PLA×12, PET×5, nGen×4, TPU×4, ASA×2 |
| carbon | colorFabb | Not read | Not read | density 1,35 g/cm3; melting 235-255 °C — this maker's range: PLA×12, PET×5, nGen×4, TPU×4, ASA×2 |
| ColorFabb StoneFill | colorFabb | Not read | Not read | this maker's range: PLA×12, PET×5, nGen×4, TPU×4, ASA×2 |
| colorFabb Woodfill Fine | colorFabb | Not read | Not read | this maker's range: PLA×12, PET×5, nGen×4, TPU×4, ASA×2 |
| colorFabb XT Light Blue | colorFabb | Not read | Not read | this maker's range: PLA×12, PET×5, nGen×4, TPU×4, ASA×2 |
...
| ColorFabb HT | colorFabb | Not read | Not read | its numbers admit PLA, PCTG, CPE, PC, PC-ABS, PC-PBT, PAHT, PPA, PVA, BVOH, TPU, TPE, TPC — density 1.2 g/cm3 — this maker's range: PLA×12, PET×5, nGen×4, TPU×4, ASA×2 |
| ColorFabb XT 2 | colorFabb | Not read | Not read | its numbers admit PLA, PETG, CPE, PC-PBT, PVA, TPU, TPC, PBAT — density 1.27 g/cm3 — this maker's range: PLA×12, PET×5, nGen×4, TPU×4, ASA×2 |
...
| colorFabb XT | colorFabb | Not read | Not read | its numbers admit PLA, PETG, CPE, PC-PBT, PVA, TPU, TPC, PBAT — density 1,27 g/cm3 — this maker's range: PLA×12, PET×5, nGen×4, TPU×4, ASA×2 |
...
| spectrum greeny pro | Spectrum | Not read | Not read | its numbers admit PET, PPS, PVA — density 1.34 g/cm3; vicat 160 °C — this maker's range: PLA×28, PETG×12, ASA×9, PA6×8, TPU×7 |
...
| Product | Maker | Reading | It would join | Read from |
|---|---|---|---|---|
| colorFabbPABlueMetalDetectable | colorFabb | Not read | Not read | its numbers admit PLA, PETG, PCTG, CPE, PC-PBT, PVA, BVOH, TPU, TPE, TPC, PBAT — density 1,25 g/cm3 — this maker's range: PLA×12, PET×5, nGen×4, TPU×4, ASA×2 |
...
| colorFabb PA NEAT | colorFabb | Not read | Not read | its numbers admit PLA, PETG, PCTG, CPE, PC-PBT, PVA, BVOH, TPU, TPE, TPC, PBAT — density 1.25 g/cm3 — this maker's range: PLA×12, PET×5, nGen×4, TPU×4, ASA×2 |
| PA Blue Metal Detectable | colorFabb | Not read | Not read | its numbers admit PLA, PETG, PCTG, CPE, PC-PBT, PVA, BVOH, TPU, TPE, TPC, PBAT — density 1.25 g/cm3 — this maker's range: PLA×12, PET×5, nGen×4, TPU×4, ASA×2 |
...
| eSUN TPE 83A Filament | eSUN | Not read | Not read | polymers the page prints somewhere: TPU×1 — its numbers admit PC-ABS, PA6, PA66, PA6/66, PAHT, PPA, BVOH, TPU, TPE, TPC — density 1.14 g/cm3 — this maker's range: PLA×30, ABS×7, PETG×7, TPU×3, PEBA×1 |
...
| PA Rail | Nanovia | Not read | Not read | polymers the page prints somewhere: PLA×4, PEI×3, ASA×2, PC×2, ABS×1, HIPS×1 — this maker's range: PC×5, PLA×4, ABS×4, PETG×4, PA6×3 |
...
| spectrum thermatech pa | Spectrum | Not read | Not read | its numbers admit PLA, PETG, CPE, PET, PPS, PVA, TPU, PBT — density 1.30 g/cm3 — this maker's range: PLA×28, PETG×12, ASA×9, PA6×8, TPU×7 |
...
| ultrafuse paht cf15 | Ultrafuse | PAHT | PAHT (new material) | the sheet declares PAHT and Unfilled / unspecified, and no material holds that pair; title: paht |
...
| eSun Wood Filament | eSUN | PLA | PLA / Unfilled / unspecified | the maker's own page for it says so: https://shop3d.ca/products/esun-wood-filament-1-75mm-1kg-spool |
...
| Product | Maker | Reading | It would join | Read from |
|---|---|---|---|---|
| BioFil Wood 1 | FormFutura | Not read | Not read | polymers the page prints somewhere: PLA×1, SAN×1 — its numbers admit PLA, PETG, PCTG, CPE, PC-PBT, PVA, TPU, TPC, PBAT — density 1.26 g/cm3; vicat 50 °C — this maker's range: PLA×3, PETG×3, PET×2, ASA |
...
| Spectrum PETG Glitter | Spectrum | Not read | Not read | the maker's page names PET and PETG — polymers the page prints somewhere: PETG×3, PET×1 — its numbers admit PLA, PETG, CPE, PC-PBT, PVA, TPU, TPC, PBAT — density 1.27 g/cm3 — this maker's range: PLA×2 |
...
before any of it is written. **15 material(s)** across 28 document(s):
...
| **PAHT** | Ultrafuse ultrafuse paht cf15; QIDI ULTRAPA | the sheet declares PAHT and Unfilled / unspecified, and no material holds that pair; title: paht |
