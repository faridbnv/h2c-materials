...
export const RULES = {
  ...
  'AUDIT-REVIEW-FINDING': r('error', 'audit', 'A per-record build finding (an outlier, an imprecise estimate, a reinforced material below its sibling, an unstated HDT load, a material with no measurements) is neither fixed nor accepted with a reason.', 'Fix it, or accept it: npm run data:lint -- --accept CODE "reason".'),
